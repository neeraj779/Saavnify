...
import {
	...
	SourceShowDetails,
	SourceShow,
} from '../types/external/show.types';
import { EpisodeDetail, Episode, Season, ShowDetails, Show } from '../types/internal/show.types';
import { artistMapPayload } from './artist.mapper';

export function showsPayload(s: SourceShow): Show {
	const {
		show_details,
		seasons,
		episodes,
		modules: { episodes: e, seasons: se, show_details: s_d, show_starring: s_s },
	} = s;
...
function showDetailsPayload(s: SourceShowDetails): ShowDetails {
	const {
		id,
		title,
		subtitle,
...
function seasonPayload(s: SourceSeason): Season {
	const {
		id,
		title,
		subtitle,
...
export function episodePayload(e: SourceEpisode): Episode {
	const {
		episodes,
...
export function episodeDetailPayload(e: SourceEpisodeDetail): EpisodeDetail {
	const {
		id,
		title,
		subtitle,
