...
export type Modules = BaseModules & {
	[key: string]: Module<Promo> | BaseModules[keyof BaseModules];
};

export type ModulesMini = BaseMiniModules & {
	[key: string]: Module<MiniEntity> | BaseMiniModules[keyof BaseMiniModules];
};
